...
export const routes: Routes = [
  ...
  { path: '', component: ContenidoComponent, canActivate: [AutenticacionService], loadChildren: () => import('./modules/admincatalogos/admincatalogos.module').then(m => m.AdminCatalogosModule) },
