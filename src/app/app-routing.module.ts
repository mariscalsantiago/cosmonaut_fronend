...
export const routes: Routes = [
  ...
  { path: 'empresa', component: ContenidoComponent, canActivate: [ProteccionRutasService], canLoad:[LoadingRutasService], loadChildren: () => import('./modules/empresas/empresas.module').then(m => ConfiguracionesService.establecerMenu(m).EmpresasModule) },
