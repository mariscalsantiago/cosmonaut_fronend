...
export const routes: Routes = [
  ...
  { path: 'kiosko', component: ContenidoComponent,canActivate:[ProteccionRutasLoginService], loadChildren: () => import('./modules/Kiosko/kiosko.module').then(m => ConfiguracionesService.establecerMenu(m).kioskoModule) },
