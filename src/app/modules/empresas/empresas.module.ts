...
@NgModule({
    declarations: [EmpresasComponent, ListaEmpresasComponent, DetalleempresasComponent,InformacionempresaComponent,DomicilioComponent,DatosbancariosComponent,DatosimssComponent,SedeComponent],
    imports: [
      CommonModule, 
