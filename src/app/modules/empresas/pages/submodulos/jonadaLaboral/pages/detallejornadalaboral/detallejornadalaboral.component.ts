...
export class DetallejornadalaboralComponent implements OnInit {
  ...
  public crearForm(obj: any) {
    ...
    return this.formbuilder.group({
      ...
      horaEntrada: [{value: obj.horaEntrada, disabled: this.esInsert}, [Validators.required]],
      horaSalida: [{value: obj.horaSalida, disabled: this.esInsert}, [Validators.required]],
