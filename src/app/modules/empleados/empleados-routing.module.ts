...
import { EsperarEmpleadoResolver } from './resolvers/esperar-empleado.resolver';
import { CatalogoGruponominaResolver } from './resolvers/catalogo-gruponomina.resolver';
...
const routes: Routes = [{
  path:'',children:[
     ...
     {path:':id',component:EmpleadoComponent,resolve:{contratoColaborador:EsperarEmpleadoResolver,gruponomina:CatalogoGruponominaResolver},loadChildren:()=> import('./pages/submodulos/pagos/empleados-pagos.module').then(m => m.empleadosPagosModule)},
