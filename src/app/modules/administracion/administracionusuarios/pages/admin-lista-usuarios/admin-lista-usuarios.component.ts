...
export class AdminListaUsuariosComponent implements OnInit {
  ...
  */
  ...
  constructor(private routerPrd: Router, private usuariosPrd: AdminUsuariosService,
  ...
  public verdetalle(obj: any) {
    if (obj == undefined) {
      this.routerPrd.navigate(["/admin/users/details"] );
    } else {
      this.routerPrd.navigate(["/admin/users/details", obj.personaId], { state: { company: this.arregloCompany } });
    }
  }
